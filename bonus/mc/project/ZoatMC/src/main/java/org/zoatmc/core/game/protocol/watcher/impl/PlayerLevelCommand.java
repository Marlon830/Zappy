...
import org.zoatmc.core.game.event.watcher.ZGamePlayerLevelEvent;
import org.zoatmc.core.game.object.ZPlayer;
import org.zoatmc.core.game.protocol.ZCommandExecutor;

public class PlayerLevelCommand implements ZCommandExecutor {
    @Override
    public void onCommand(ZGame game, String command, String[] args) {
        ...
        game.getEventBus().postEvent(new ZGamePlayerLevelEvent(game, player, level));
        player.update(false);
    }
}
