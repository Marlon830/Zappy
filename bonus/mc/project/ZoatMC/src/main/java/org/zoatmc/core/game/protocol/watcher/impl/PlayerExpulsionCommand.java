...
import org.zoatmc.core.game.event.watcher.ZGamePlayerExpulsionEvent;
import org.zoatmc.core.game.object.ZPlayer;
import org.zoatmc.core.game.protocol.ZCommandExecutor;

public class PlayerExpulsionCommand implements ZCommandExecutor {
    @Override
    public void onCommand(ZGame game, String command, String[] args) {
        ...
        game.getEventBus().postEvent(new ZGamePlayerExpulsionEvent(game, player));
    }
}
