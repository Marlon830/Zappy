...
import org.zoatmc.core.game.event.watcher.ZGamePlayerDropResourceEvent;
...
public class PlayerDropResourceCommand implements ZCommandExecutor {
    @Override
    public void onCommand(ZGame game, String command, String[] args) {
        ...
        game.getEventBus().postEvent(new ZGamePlayerDropResourceEvent(game, player, resourceType));
    }
}
