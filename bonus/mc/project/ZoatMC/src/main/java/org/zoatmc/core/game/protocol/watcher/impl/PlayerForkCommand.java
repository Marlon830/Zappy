...
import org.zoatmc.core.game.event.watcher.ZGamePlayerForkEvent;
import org.zoatmc.core.game.object.ZPlayer;
import org.zoatmc.core.game.protocol.ZCommandExecutor;

public class PlayerForkCommand implements ZCommandExecutor {
    @Override
    public void onCommand(ZGame game, String command, String[] args) {
        ...
        game.getEventBus().postEvent(new ZGamePlayerForkEvent(game, player));
    }
}
