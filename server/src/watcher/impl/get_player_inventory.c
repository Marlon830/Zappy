...
void game_watcher_cmd_get_player_inventory(UNUSED game_watcher_t *self,
    csocket_t *client, list_t *args)
{
    ...
    game_watcher_send_player_inventory(client, player);
    SERVER_LOG(trace, "Player #%d inventory sent to client %s",
